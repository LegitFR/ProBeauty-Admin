...
import { SalonAnalytics } from "@/components/salon-analytics";
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 sm:px-6 py-4 sm:py-8 max-w-7xl">
        ...
        <Tabs defaultValue="details" className="space-y-6">
          <TabsList>
            <TabsTrigger value="details">Salon Details</TabsTrigger>
                              ...
                              <Avatar className="h-10 w-10">
                                {staff.image ? (
                                  ...
                                  <AvatarFallback className="text-sm">
                                    {(staff.name || staff.user?.name || "S")[0]}
                                  </AvatarFallback>
                                )}
                              </Avatar>
          ...
          <TabsContent value="analytics">
            <SalonAnalytics salonId={salonId} salonName={salon.name} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
